...
// Hour lines (inside each day col via CSS background, not DOM)
// → use a repeating linear gradient on each col instead
...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Individual day column — flex child, position:relative for absolute sessions */
  .day-col {
    flex:1;
    min-width:0;
    position:relative;
    border-left:1px solid #e4e4e7;
    /* Hour lines via repeating gradient */
  ...
  .sblock-top { display:flex; align-items:center; gap:5px; min-width:0; overflow:hidden; }
  .sport-dot {
    width:20px; height:20px; border-radius:5px;
    background:#18181b;           /* always dark — no green */
    display:flex; align-items:center; justify-content:center;
    flex-shrink:0;
  }
  .sport-dot img { width:12px; height:12px; object-fit:contain; filter:invert(1); }
  .sblock-title {
    font-size:11px; font-weight:500; color:#09090b;
  ...
  .sblock-done {
    display:flex; align-items:center; gap:3px; /* aligned */
    overflow:hidden;
  }
  .done-check { font-size:10px; color:#16a34a; line-height:1; flex-shrink:0; }
  .done-text  { font-size:10px; color:#16a34a; line-height:1; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }

  /* ── DETAIL PANEL ── */
  .detail-panel { width:264px; min-width:264px; background:#fff; border-left:1px solid #e4e4e7; display:flex; flex-direction:column; overflow-y:auto; flex-shrink:0; }
  .detail-header { display:flex; align-items:center; justify-content:space-between; padding:20px 18px 0; margin-bottom:14px; }
  .detail-label { font-size:10px; text-transform:uppercase; letter-spacing:0.12em; color:#a1a1aa; }
  .detail-close { width:24px; height:24px; border-radius:6px; border:1px solid #e4e4e7; background:transparent; cursor:pointer; display:flex; align-items:center; justify-content:center; color:#71717a; font-size:14px; line-height:1; flex-shrink:0; }
  .detail-close:hover { background:#f4f4f5; color:#09090b; }
        ...
        <div class="day-cols">
          ...
          <div class="day-col">
            <div class="sblock done" style="top:${top(7,0)}px;height:${height(45)}px">
              <div class="sblock-top">
                <div class="sport-dot"><img src="${runner}" alt=""></div>
                <div class="sblock-title">Sortie facile</div>
              </div>
              <div class="sblock-done">
                <span class="done-check">✓</span>
                <span class="done-text">Complétée · 45 min</span>
              </div>
            </div>
          </div>
          ...
          <div class="day-col">
            <div class="sblock done" style="top:${top(7,0)}px;height:${height(75)}px">
              <div class="sblock-top">
                ...
                <div class="sblock-title">Zone 2 vélo</div>
              </div>
              <div class="sblock-meta">75 min</div>
              <div class="sblock-done">
                <span class="done-check">✓</span>
          ...
          <div class="day-col today-col">
            ...
            <div class="sblock selected" style="top:${top(17,0)}px;height:${height(55)}px">
              <div class="sblock-top">
                <div class="sport-dot"><img src="${runner}" alt=""></div>
                <div class="sblock-title">Tempo progressif</div>
              </div>
              <div class="sblock-meta">55 min · 17h00</div>
            </div>
          </div>
          ...
          <div class="day-col">
            <div class="sblock planned" style="top:${top(7,0)}px;height:${height(45)}px">
              <div class="sblock-top">
                ...
                <div class="sblock-title">Endurance eau</div>
              </div>
              <div class="sblock-meta">45 min · 7h00</div>
            </div>
          </div>
          ...
          <div class="day-col">
            <div class="sblock planned" style="top:${top(9,0)}px;height:${height(90)}px">
              <div class="sblock-top">
                <div class="sport-dot"><img src="${runner}" alt=""></div>
                <div class="sblock-title">Long run Z2</div>
              </div>
              <div class="sblock-meta">90 min · 9h00</div>
            </div>
          </div>
...
fs.writeFileSync('C:/Users/simon/resilio-plus/.superpowers/brainstorm/1005-1775853957/content/plan-v3.html', html);
console.log('done');
