...
from .routes.connectors import router as connectors_router, oauth_router as connectors_oauth_router
...
from .routes.food import router as food_router, food_public_router
...
app.include_router(food_public_router)
