"""Recovery Coach V2 — conservé pour compatibilité avec _agent_factory.

Le package recovery_coach/ remplace le module recovery_coach.py.
Ce fichier re-implémente la V2 à l'identique avec les imports ajustés.
"""
