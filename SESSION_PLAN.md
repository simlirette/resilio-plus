...
4. [ ] Implement `backend/app/graphs/weekly_review_graph.py`
5. [ ] Add `weekly_review()` + `resume_review()` to `CoachingService`
6. [ ] Add `/plan/review/start` + `/plan/review/confirm` endpoints to `workflow.py`
7. [ ] Write tests: `tests/backend/graphs/test_weekly_review_graph.py`
8. [ ] Write tests: `tests/backend/api/test_weekly_review_endpoints.py`
9. [ ] Run pytest ≥ 1243 passing
10. [ ] Commit + push + write SESSION_REPORT.md
