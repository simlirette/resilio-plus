...
- **Clinique, direct, factuel** — pas de fioriture, pas de marketing flou
- **Jamais condescendant** — l'athlète est compétent, on lui fournit des données, pas des leçons
- **Dense en information** — chaque mot justifié, chaque chiffre affiché est utile
- **Vocabulaire coach** — "séance", "charge", "allostatic score", "readiness", pas "workout", "burn", "fitness level"

---

## Langue de l'interface

- **Langue UI principale: français** — toutes les étiquettes, boutons, messages d'état
- **Langue code: anglais** — noms de variables, fonctions, classes, commits
- **Termes techniques en anglais** autorisés dans l'UI quand c'est l'usage courant dans le sport : "VDOT", "RPE", "ACWR", "HRV", "FTP", "CTL/ATL/TSB"
